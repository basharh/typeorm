...
export class BaseEntity {
    ...
    static findAndCount<T extends BaseEntity>(
        ...
        return (this as any)
            .getRepository()
            .findAndCount(optionsOrConditions as any);
    }
    ...
    static findByIds<T extends BaseEntity>(
        ...
        return (this as any)
            .getRepository()
            .findByIds(ids, optionsOrConditions as any);
    }
    ...
    static findOne<T extends BaseEntity>(
        ...
        return (this as any)
            .getRepository()
            .findOne(optionsOrConditions as any, maybeOptions);
    }
    ...
    static findOneOrFail<T extends BaseEntity>(
        ...
        return (this as any)
            .getRepository()
            .findOneOrFail(optionsOrConditions as any, maybeOptions);
    }

        ...
        if (
            ...
            if (oldColumn.name !== newColumn.name) {
                ...
                if (
                    ...
                    const seqName = this.buildSequenceName(
                        table,
                        oldColumn.name,
                        undefined,
                        true,
                    ...
                    const newSeqName = this.buildSequenceName(
                        table,
                        newColumn.name,
                        undefined,
                        true,
                    ...
                    const up = schema
                        ? `ALTER SEQUENCE "${schema}"."${seqName}" RENAME TO "${newSeqName}"`
                        : `ALTER SEQUENCE "${seqName}" RENAME TO "${newSeqName}"`;
                    const down = schema
                        ? `ALTER SEQUENCE "${schema}"."${newSeqName}" RENAME TO "${seqName}"`
            ...
            if (
                ...
                if (newColumn.isGenerated === true) {
                    ...
                    downQueries.push(
                        new Query(
                            `DROP SEQUENCE ${this.buildSequenceName(
                                table,
                                newColumn
                            )}`
                        )
                    ...
                    upQueries.push(
                        new Query(
                            `ALTER TABLE ${this.escapePath(
                                ...
                                newColumn.name
                            }" SET DEFAULT nextval('${this.buildSequenceName(
                                table,
                                newColumn,
                                undefined,
                                true
